## Sexual_Dimorphism_Mosue _Brain: This repository contains MATLAB files for various image processing and analysis tasks that were built and customized for the “Sexual dimorphism in synaptic inputs to mouse amygdala and orbital cortex” article by Etay Aloni et. al. ,Zeisel lab, biotechnology and food emgineering faculty , Technion. Codes are written or added by Muhammad Tibi from the same lab. The MATLAB files included in this repository are as follows:
